  ...
  return (
    <div role="presentation" className={`app-splash ${isExiting ? 'app-splash--exiting' : ''}`}>
      <svg className="app-splash__mark" viewBox="0 0 512 512" aria-hidden="true">
        <rect
          className="app-splash__plate app-splash__plate--left"
          x="90"
          y="156"
          width="56"
          height="200"
        ...
        />
        <rect
          className="app-splash__collar app-splash__collar--left"
          x="150"
          y="196"
          width="24"
          height="120"
        ...
        <rect
          className="app-splash__collar app-splash__collar--right"
          x="338"
          y="196"
          width="24"
          height="120"
        ...
        />
        <rect
          className="app-splash__plate app-splash__plate--right"
          x="366"
          y="156"
          width="56"
          height="200"
